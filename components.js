...
const ICON_PATHS = {
  ...
  handHeart:
    '<path d="M11 14h2a2 2 0 0 0 0-4h-3c-.6 0-1.1.2-1.4.6L3 16"/><path d="m7 20 1.6-1.4c.3-.4.8-.6 1.4-.6h4c1.1 0 2.1-.4 2.8-1.2l4.6-4.4a2 2 0 0 0-2.75-2.91l-4.2 3.9"/><path d="m2 15 6 6"/><path d="M19.5 8.5c.7-.7 1.5-1.6 1.5-2.7A2.73 2.73 0 0 0 16 4a2.78 2.78 0 0 0-5 1.8c0 1.2.8 2 1.5 2.8L16 12Z"/>',
  sprout:
  ...
  award:
    '<path d="m15.4 12.9 1.5 8.5a.5.5 0 0 1-.8.5l-3.6-2.7a1 1 0 0 0-1.2 0l-3.6 2.7a.5.5 0 0 1-.8-.5l1.5-8.5"/><circle cx="12" cy="8" r="6"/>',
  certificate:
  ...
  instagram:
    '<rect width="20" height="20" x="2" y="2" rx="5"/><path d="M16 11.4A4 4 0 1 1 12.6 8 4 4 0 0 1 16 11.4z"/><line x1="17.5" x2="17.5" y1="6.5" y2="6.5"/>',
  youtube:
  ...
  whatsapp:
    '<path d="M3 21l1.65-3.8a9 9 0 1 1 3.4 2.9z"/><path d="M9 9.5c0 3 2.5 5.5 5.5 5.5l1-1.4-2-1-.8.8a4 4 0 0 1-2-2l.8-.8-1-2z"/>',
  scale:
  ...
  return `
    <a href="index.html" class="logo" aria-label="Shri Mandal Mahajan Panjrapole — Home">
      ...
      <span class="logo-text">
        ...
        <span class="logo-sub">Panjrapole </span>
      </span>
    </a>`;
}
        ...
        <div class="footer-grid">
          ...
          <div>
            ...
            <ul class="footer-links footer-contact">
              <li>${icon("pin")}<span><strong>Panjrapole:</strong> Mandal, Taluka Viramgam,<br>Dist. Ahmedabad, Gujarat 382130</span></li>
  ...
  return `
    <div class="loader" id="loader" role="status" aria-label="Loading">
      <div class="loader-inner">
        ...
        <div class="loader-tagline"> Mandal, Gujarat</div>
